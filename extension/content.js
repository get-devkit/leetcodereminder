  ...
  return new Promise((resolve, reject) => {
    ...
    if (body) {
      let usernameContainer = document.querySelector(
        ".content-wrapper #base_content #profile-app .profile-app__KJyN .header__NyBc .container__28Ei .user-info__2aLr .leetcodeId__13b9"
      );
...
async function hideReminder() {
  //* Sends Message
  chrome.runtime.sendMessage({ hideReminder: true }, (response) => {
